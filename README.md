# 마카롱맛 프로젝트
자동화된 인프라 관리 서비스는 개발 효율을 크게 상승시켜주는 유용한 서비스입니다.

AWS의 EC2와 같이 서버의 생성/삭제를 간편하게 돕는 컴퓨팅 서비스는 어떻게 구현되어 있는지 궁금증이 생겨 직접 구현해보게 되었습니다.

NDC17에서 발표된 오승용 개발자님의 [Kubernetes로 개발서버 간단히 찍어내기](https://www.slideshare.net/seungyongoh3/ndc17-kubernetes)를 참고하여 개발하였습니다.

마카롱맛 프로젝트에서는 관리자 대시보드에서 서버를 클릭 한 번으로 간편하게 생성하거나 삭제할 수 있습니다.
